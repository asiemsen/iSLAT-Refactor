...
class PlotParamsFrame(ToolFrame): 
    def build(self):
        ...
        self.xp1_entry = tk.Entry(self, bg="lightgray", width=8)
        self.xp1_entry.insert(0, str(app_globals.xp1))
        self.xp1_entry.grid(row=0, column=0)
        ...
        self.rng_entry = tk.Entry(self, bg='lightgray', width=8)
        ...
        self.min_lamb_entry = tk.Entry(self, bg='lightgray', width=8)
        ...
        self.max_lamb_entry = tk.Entry(self, bg='lightgray', width=8)
        ...
        self.dist_entry = tk.Entry(self, bg='lightgray', width=8)
        ...
        self.star_rv_entry = tk.Entry(self, bg='lightgray', width=8)
        ...
        self.fwhm_entry = tk.Entry(self, bg='lightgray', width=8)
        ...
        self.intrinsic_line_width_entry = tk.Entry(self, bg='lightgray', width=8)
        ...
        self.specsep_entry = tk.Entry(self, bg='lightgray', width=8)
        ...
        self.spanoptionsvar = list(self.moleculeManager.moleculeDictionary.keys())
